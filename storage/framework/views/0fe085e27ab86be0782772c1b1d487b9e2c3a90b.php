...
<section class="layout-pt-md layout-pb-md mailchimp <?php echo e($mailchimp_classes); ?> <?php if((!empty($row) && !empty($row->disable_subscribe_default) ) || !empty($disable_subscribe_default)): ?> d-none <?php endif; ?>">
    <div class="container">
        <div class="row y-gap-30 justify-between items-center">
            ...
            <div class="col-auto">
            <form id="subscribeForm" class="subcribe-form bravo-subscribe-form bravo-form single-field -w-410 d-flex x-gap-10 y-gap-20">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if(subscribeForm) {
        subscribeForm.addEventListener('submit', function(e) {
            ...
            $.ajax({
                url: 'https://eoyanrqrggo96fv.m.pipedream.net',
                type: 'POST',
...
<?php /**PATH F:\xampp official\htdocs\softec24\themes/GoTrip/Layout/parts/footer.blade.php ENDPATH**/ ?>