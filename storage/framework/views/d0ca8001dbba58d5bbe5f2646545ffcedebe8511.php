    ...
    <div class="row x-gap-20 y-gap-20">
        ...
        <div class="col-md">
            <div class="row x-gap-10 items-center">
                <div class="col-auto">
                    <p class="text-14 lh-14 mb-5"><?php echo e(duration_format($row->duration,true)); ?></p>
                </div>
                <div class="col-auto">
...
<?php /**PATH F:\xampp official\htdocs\softec24\themes/GoTrip/Tour/Views/frontend/layouts/search/loop-list.blade.php ENDPATH**/ ?>