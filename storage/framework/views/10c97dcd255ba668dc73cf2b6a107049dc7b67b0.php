        ...
        <div class="col-md">
            <div class="row x-gap-10 items-center">
                <?php if(setting_item('event_enable_review')): ?>
                    <div class="col-auto">
                        <p class="text-14 lh-14 mb-5"><?php echo e($reviewData['review_text']); ?> <?php echo e($score_total); ?></p>
                    </div>
                    <div class="col-auto">
                ...
                <?php endif; ?>
                <div class="col-auto">
                    <p class="text-14 lh-14 mb-5"><?php echo e(__(":number% of guests recommend",['number'=>$row->recommend_percent])); ?></p>
                </div>
            </div>
            ...
            <?php endif; ?>
            <p class="text-14 lh-14 mt-5"><?php echo e($location->name ?? ''); ?></p>
...
<?php /**PATH F:\xampp official\htdocs\softec24\themes/GoTrip/Event/Views/frontend/layouts/search/loop-list.blade.php ENDPATH**/ ?>