                    ...
                    <div class="accordion__button d-flex items-center">
                        <button class="button text-dark-1 shrink-0  px-20 " type="button">
                            <label class="d-flex items-center" data-toggle="collapse" data-target="#gateway_<?php echo e($k); ?>" >
                                <input type="radio" name="payment_gateway" checked value="<?php echo e($k); ?>">
...
<?php /**PATH F:\xampp official\htdocs\softec24\themes/GoTrip/Booking/Views/frontend/booking/checkout-payment.blade.php ENDPATH**/ ?>