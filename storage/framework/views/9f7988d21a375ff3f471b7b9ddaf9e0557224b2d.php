...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('news.vendor.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])); ?>" method="post" class="dungdt-form">
        <div class="row y-gap-20 justify-between items-end pb-20 lg:pb-40 md:pb-20">
            <div class="col-auto">
                <h1 class="text-30 lh-14 fw-600"><?php echo e($row->id ? __('Edit post: ').$row->title : __('Add new Post')); ?></h1>
...
<?php echo $__env->make('Layout::user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp official\htdocs\softec24\themes/GoTrip/News/Views/frontend/vendor/detail.blade.php ENDPATH**/ ?>